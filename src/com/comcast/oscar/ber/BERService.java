...
public class BERService {
   ...
   * @throws Exception
   */
  public static String setOIDEncoding(String sObjectID, byte bBerDataType, long lNumber)
      throws Exception {

    if (logger.isDebugEnabled()) {
      logger.debug(
          "BERService.setOIDEncoding(s,b,l) - OID: " + sObjectID + " -> Value: " + lNumber);
    }
    ...
    if ((BER.COUNTER == bBerDataType) || (BER.COUNTER32 == bBerDataType)) {
      ...
      try {
        ...
        logger.debug(
            "OID Conversion Error Found, Most likely unable to convert OID name to BER encoding");
   ...
   * @throws Exception
   */
  public static String setOIDEncoding(String sObjectID, byte bBerDataType, String sValue)
      throws Exception {
   ...
   * @throws Exception
   */
  public static String setOIDEncoding(String sObjectID, byte bBerDataType, byte[] bValue)
      throws Exception {

    if (logger.isDebugEnabled()) {
      logger.debug(
          "BERService.setOIDEncoding(s,b,b) - OID: "
              + sObjectID
              + " -> Value: "
   ...
   * @throws Exception
   */
  public static byte[] setOIDEncodingToByteArray(String sObjectID, byte bBerDataType, String sValue)
      throws Exception {

    if (logger.isDebugEnabled()) {
      logger.debug(
          "BERService.setOIDEncodingToByteArray(s,b,s) - OID: "
              + sObjectID
              + " -> Value: "
              + sValue);
    }
    ...
    if (bBerDataType == HEX) {
      return HexString.toByteArray(
          setOIDEncoding(sObjectID, BER.OCTETSTRING, HexString.toByteArray(sValue)));
    } else {
   ...
   * @throws Exception
   */
  public static byte[] setOIDEncodingToByteArray(String sObjectID, byte bBerDataType, long lNumber)
      throws Exception {
