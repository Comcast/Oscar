...
public class HexDisplay {
  ...
  public static final Option OptionParameters() {
    ...
    OptionBuilder.withDescription(
        "Display the hex of the input file. Option s creates a single string (EX: xx:xx:xx:...)."
            + " Option t creates a newline at the start of every top level TLV (binary files"
            + " only).");
