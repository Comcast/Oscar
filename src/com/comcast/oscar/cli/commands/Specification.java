...
public class Specification {
  ...
  public static final String ERROR =
      "No specification found. Please set the specification and version. EX: -s d 1.1 (DOCSIS 1.1)"
          + " / -s p 1.5 (PacketCable 1.5).";
  ...
  public static final Option OptionParameters() {
    ...
    OptionBuilder.withDescription(
        "Set specification and version of the file to be compiled/decompiled EX: -s d 1.1 (DOCSIS"
            + " 1.1) / -s p 1.5 (PacketCable 1.5).");
    return OptionBuilder.create("s");
  }

  /**
   * Sets the ConfigurationFileType, TlvDisassemble and PacketCable boolean passed on user
   * arguments.
   *
   * @param args
   */
  public void setValues(String[] args) {
    ...
    if (sSpecification.equalsIgnoreCase("d") || sSpecification.equalsIgnoreCase("docsis")) {
      ...
      if (sVersion.equalsIgnoreCase("1")
          || sVersion.equalsIgnoreCase("10")
          || sVersion.equalsIgnoreCase("1.0")) {
      ...
      if (sVersion.equalsIgnoreCase("2")
          || sVersion.equalsIgnoreCase("20")
          || sVersion.equalsIgnoreCase("2.0")) {
        this.iConfigurationFileType = ConfigurationFileTypeConstants.DOCSIS_20_CONFIGURATION_TYPE;
      }

      if (sVersion.equalsIgnoreCase("3")
          || sVersion.equalsIgnoreCase("30")
          || sVersion.equalsIgnoreCase("3.0")) {
    ...
    } else if (sSpecification.equalsIgnoreCase("p")
        || sSpecification.equalsIgnoreCase("packetcable")) {
      this.iConfigurationFileType = -1;
