...
public class PrettyPrint extends StringTokenizer {
  ...
  public PrettyPrint(String sInputCode) {
    // This is a total Hack. This will only take care of TLV that are 4 levels deep.  Will use
    // Matcher Check in next release
    super(
        (sInputCode
            .replaceAll("\\s+", " ")
            .replaceAll("\\*/", " */")
  ...
  public static String ToParagraphForm(String sText) {
    ...
    int iOffSet = PARAGRAPH_OFFSET, iIndex = iOffSet;
