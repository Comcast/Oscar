...
public class EditDocsisFile {
  ...
  public static void main(String[] args) {
    ...
    ArrayDeque<String> ads =
        DictionaryTLV.getTypeHierarchyStack(
            "3", new DictionarySQLQueries(DictionarySQLQueries.DOCSIS_DICTIONARY_TABLE_NAME));
    ...
    ConfigurationFileExport cfe =
        new ConfigurationFileExport(
            new TlvAssembler(ja).clone(), ConfigurationFileExport.DOCSIS_VER_10);
