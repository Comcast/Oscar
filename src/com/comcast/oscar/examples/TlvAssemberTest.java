...
public class TlvAssemberTest {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "+----------------------------------------TLV:"
            + " 11-OID---------------------------------------------------------------------+");
    String sTlv11JsonArray =
        "[{\"ByteLength\":1,\"LengthMax\":0,\"LengthMin\":0,\"Value\":{\"OID\":\"1.3.6.1.6.3.16.1.2.1.3.1.12.114.101.97.100.119.114.105.116.101.115.101.99\",\"VALUE\":\"readwritegroup\",\"DATA_TYPE\":\"4\"},\"TlvName\":\"SnmpMib\",\"DataType\":\"oid\",\"AreSubTypes\":false,\"Type\":\"11\",\"SupportDocsisVersion\":\"1.0\",\"ParentTypeList\":[-1,11]}]";
