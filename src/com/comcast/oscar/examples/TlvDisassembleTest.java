...
*/
		System.out.println("+----------------------------------READ-DOCSIS-FILE---------------------------------------------------+");

        File file = new File("c:\\d10_syscontact.cm");
       
		TlvDisassemble tdDocsisConfig = new TlvDisassemble(file,DictionarySQLConstants.DOCSIS_DICTIONARY_TABLE_NAME);

		System.out.println("+----------------------------------SORT MAJOR TLV---------------------------------------------------+");
