...
/**
 */
public class PacketCableCompileDecompileWithKeyTest {
	...
	public static void main (String[] args) {
		...
		arguments[0] = "-c";
		arguments[1] = "-i";
		arguments[2] = "testfiles/IMS-PKT-CABLE-CONFIG.txt";
		arguments[3] = "-o";
		arguments[4] = "output/IMS-PKT-CABLE-CONFIG.bin";
		arguments[5] = "-k";
		arguments[6] = "testfiles/sharedsecret.txt";
