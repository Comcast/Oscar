    ...
    try {
      System.out.println(
          "COUNTER32-OID: "
              + SnmpOID
              + " \t-> BER: "
              + BERService.setOIDEncoding(SnmpOID, BER.COUNTER32, lNum));
    } catch (Exception e) {
    ...
    try {
      System.out.println(
          "COUNTER64-OID: "
              + SnmpOID
              + " \t-> BER: "
              + BERService.setOIDEncoding(SnmpOID, BER.COUNTER64, lNum));
    } catch (Exception e) {
      e.printStackTrace();
    }
    ...
    try {
      System.out.println(
          "GAUGE32-OID: "
              + SnmpOID
              + " \t-> BER: "
              + BERService.setOIDEncoding(SnmpOID, BER.GAUGE32, lNum));
    } catch (Exception e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
    }
    ...
    try {
      System.out.println(
          "INTEGER32-OID: "
              + SnmpOID
              + " \t-> BER: "
              + BERService.setOIDEncoding(SnmpOID, BER.INTEGER32, lNum));
    } catch (Exception e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
    }
    ...
    try {
      System.out.println(
          "TIMETICKS-OID: "
              + SnmpOID
              + " \t-> BER: "
              + BERService.setOIDEncoding(SnmpOID, BER.TIMETICKS, lNum));
    } catch (Exception e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
    }
    ...
    try {
      System.out.println(
          "OCTETSTRING-OID: "
              + SnmpOID
              + " \t-> BER: "
              + BERService.setOIDEncoding(SnmpOID, BER.OCTETSTRING, sOctectString));
    } catch (Exception e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
    }
    ...
    try {
      System.out.println(
          "IPADDRESS-OID: "
              + SnmpOID
              + " \t-> BER: "
              + BERService.setOIDEncoding(SnmpOID, BER.IPADDRESS, sIpAddress));
    } catch (Exception e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
    }
