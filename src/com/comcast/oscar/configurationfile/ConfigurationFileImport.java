...
/**
 * ConfigrationFileImport takes a OSCAR ASCII Compliant configuration file and convert to its JSON
 * TLV Dictionary
 */
public class ConfigurationFileImport {
   ...
   */
  public ConfigurationFileImport(File fConfigfile)
    ...
    if (!HexString.verifyAsciiPlainText(HexString.fileToByteArray(fConfigfile))) {
      throw new ConfigurationFileException(
          "ConfigrationFileImport() - File is not a text File: " + fConfigfile.getName());
    }
   ...
   */
  public ConfigurationFileImport(byte[] bConfigfile)
      throws NullPointerException, ConfigurationFileException {
    ...
    if (!HexString.verifyAsciiPlainText(bConfigfile))
      throw new ConfigurationFileException(
          "ConfigrationFileImport () - Input ByteArray is not of Text Characters");
