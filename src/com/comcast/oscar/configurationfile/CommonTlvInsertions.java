...
public class CommonTlvInsertions {
   ...
   */
  public static void insertTLV(String sTLV, ConfigurationFile cf, boolean boolFinalize)
      throws TlvException {
   ...
   */
  public static void insertMaxCPE(int iMaxCPE, ConfigurationFile cf, boolean boolFinalize)
      throws ConfigurationFileException {

    if (cf.getConfigurationFileType() > ConfigurationFile.DOCSIS_VER_31)
      throw new ConfigurationFileException(
          "Invalid ConfigurationFileType: " + cf.getConfigurationFileType());
   ...
   * @throws ConfigurationFileException
   */
  public static void insertDownstreamFrequency(
      int iDownstreamFrequency, ConfigurationFile cf, boolean boolFinalize)
      throws ConfigurationFileException {
    ...
    if (logger.isDebugEnabled()) {
      logger.debug(
          "CommonTlvInsertions.insertDownstreamFrequency() - Hex: "
              + new HexString(tb.toByteArray()).toString(":"));
      logger.debug(
          "CommonTlvInsertions.insertDownstreamFrequency() - ConfigFileSize: " + cf.size());
    }
   ...
   */
  public static void insertFirmwareFileName(
      String sFileName, ConfigurationFile cf, boolean boolFinalize)
      throws ConfigurationFileException {
   ...
   * @throws ConfigurationFileException if not a DOCSIS ConfigurationFile
   */
  public static void insertManufactureCVC(
      File fCertificate, ConfigurationFile cf, boolean boolFinalize)
      throws ConfigurationFileException {
   ...
   */
  public static void insertManufactureCVC(
      byte[] bCertificate, ConfigurationFile cf, boolean boolFinalize)
      throws ConfigurationFileException {
   ...
   * @throws ConfigurationFileException if not a DOCSIS ConfigurationFile
   */
  public static void insertCoSignCVC(File fCertificate, ConfigurationFile cf, boolean boolFinalize)
      throws ConfigurationFileException {
   ...
   * @throws ConfigurationFileException if not a DOCSIS ConfigurationFile
   */
  public static void insertCoSignCVC(
      byte[] bCertificate, ConfigurationFile cf, boolean boolFinalize)
      throws ConfigurationFileException {
   ...
   */
  public void insertManufactureCVC(byte[] bCertificate, boolean overWriteTLV)
      throws NullPointerException {

    if (bCertificate == null)
      throw new NullPointerException(
          "CommonTlvInsertions.insertManufactureCVC() - Byte Array is Null");
   ...
   * @throws NullPointerException
   */
  public void insertCoSignCVC(byte[] bCertificate, boolean overWriteTLV)
      throws NullPointerException {
   ...
   * @param baDigitMap
   * @param sOID
   *     <p>This method can be used multiple time, and the number of instances can be found in the
   *     getTlvBuilderList()
   */
    ...
    if (sOID == null) {
      ltb.add(
          DigitMapOperation.getDigitMapTlvBuilder(
              baDigitMap, DigitMapOperation.DEFAULT_DIGIT_MAP_OID));
    } else {
  ...
  /**
   * @param baDigitMap
   * @param sOID = If null, will insert the Default DIGIT Map OID =
   *     DigitMapOperation.DEFAULT_DIGIT_MAP_OID
   * @param cf
   * @param boolFinalize
   * @throws ConfigurationFileException
   */
  public static void insertDigitMap(
      byte[] baDigitMap, String sOID, ConfigurationFile cf, boolean boolFinalize)
      throws ConfigurationFileException {
   ...
   * @param boolFinalize
   */
  public static void insertSnmpOID(
      String sOID, byte bDataType, long lValue, ConfigurationFile cf, boolean boolFinalize) {
   ...
   */
  public static void insertSnmpOID(
      String sOID, byte bDataType, String sValue, ConfigurationFile cf, boolean boolFinalize) {
   ...
   * @throws ConfigurationFileException
   */
  public static void insertTftpServerAddress(
      String sInetAddress, ConfigurationFile cf, boolean boolFinalize)
      throws ConfigurationFileException {
