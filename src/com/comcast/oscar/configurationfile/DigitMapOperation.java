...
public class DigitMapOperation {
  ...
  public static final String DEFAULT_DIGIT_MAP_OID = PacketCableConstants.PKT_CABLE_DIGIT_MAP_OID;
   ...
   *     <p>Example: OID: 1.3.6.1.4.1.4491.2.2.8.2.1.1.3.1.1.2.1
   *     <p>TIMER S=4.000000 TIMER Z=2.000000
   *     <p>domain = "@ims.comcast.net" dialString = ";user=dialstring" dialPhone = ";user=phone"
   */
  public String getDigitMap() {
    ...
    try {
      ...
      if (logger.isDebugEnabled()) logger.debug("DigitMapOperation.getDigitMap()" + joTLV64);
  ...
  public static TlvBuilder getDigitMapTlvBuilder(File fDigitMap) {
    ...
    DictionarySQLQueries dsqSnmp64 =
    ...
    if (logger.isDebugEnabled())
      logger.debug(
          "DigitMapOperation.getDigitMapTlvBuilder() - Snmp64 - JSON-DICTIONARY: " + joDictSnmp64);
    ...
    if (logger.isDebugEnabled()) {
      logger.debug(
          "DigitMapOperation.getDigitMapTlvBuilder() - TlvBuilder: " + tb.toStringSeperation(":"));
      logger.debug(
          "DigitMapOperation.getDigitMapTlvBuilder() - TlvBuilder-Map: "
              + tb.getMapTypeToByteLength());
    }
