...
public class ConfigurationFileBuildCLITestMethods implements TestMethod {
  ...
  public void BinaryToBinaryDOCSIS_TLV_MaxCPE_Firmware_Man_CoSignCVC() {
    /* Start Banner */
    System.out.println(
        "+---------------BinaryToBinaryDOCSIS_TLV_MaxCPE_Firmware_Man_CoSignCVC"
            + " Start---------------+");
    ...
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("DOCSIS-GOLDEN.bin.TlvFirmwareManCoSignCVC.bin")
            .toString();
    arguments[5] = "-m";
    arguments[6] = "32";
    arguments[7] = "-f";
  ...
  public void BinaryToBinaryPacketCable() {
    ...
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("IMS-PKT-CABLE-CONFIG.bin.bin").toString();
  ...
  public void BinaryToTextDOCSIS_TLV_MaxCPE_Firmware_Man_CoSignCVC() {
    /* Start Banner */
    System.out.println(
        "+---------------BinaryToTextDOCSIS_TLV_MaxCPE_Firmware_Man_CoSignCVC"
            + " Start---------------+");
  ...
  public void BinaryToTextPacketCableInsertDigitMap() {
    /* Start Banner */
    System.out.println(
        "+---------------BinaryToTextPacketCableInsertDigitMap Start---------------+");
    ...
    arguments[1] = "-i";
    arguments[2] =
        TestDirectoryStructure.fInputDirFileName("IMS-PKT-CABLE-CONFIG-NO-DIGITMAP.bin").toString();
    arguments[3] = "-dm";
    ...
    /* End Banner */
    System.out.println(
        "+---------------BinaryToTextPacketCableInsertDigitMap End-----------------+");
  }
  ...
  public void PrintBinaryToTextPacketCableDigitMap() {
    /* Start Banner */
    System.out.println(
        "+---------------PrintBinaryToTextPacketCableDigitMap Start---------------+");
    ...
    /* End Banner */
    System.out.println(
        "+---------------PrintBinaryToTextPacketCableDigitMap End-----------------+");
  }
  ...
  public void PrintBinaryToTextPacketCableJSONDump() {
    /* Start Banner */
    System.out.println(
        "+---------------PrintBinaryToTextPacketCableJSONDump Start---------------+");
    ...
    /* End Banner */
    System.out.println(
        "+---------------PrintBinaryToTextPacketCableJSONDump End-----------------+");
  }
  ...
  public void PrintDefaultDOCSISConfigurationTemplate() {
    /* Start Banner */
    System.out.println(
        "+---------------PrintDefaultDOCSISConfigurationTemplate Start---------------+");
    ...
    /* End Banner */
    System.out.println(
        "+---------------PrintDefaultDOCSISConfigurationTemplate End-----------------+");
  }
  ...
  public void PrintDefaultPacketCableConfigurationTemplate() {
    /* Start Banner */
    System.out.println(
        "+---------------PrintDefaultPacketCableConfigurationTemplate Start---------------+");
    ...
    /* End Banner */
    System.out.println(
        "+---------------PrintDefaultPacketCableConfigurationTemplate End-----------------+");
  }
  ...
  public void PrintTextToBinaryPacketCableDigitMap() {
    /* Start Banner */
    System.out.println(
        "+---------------PrintTextToBinaryPacketCableDigitMap Start---------------+");
    ...
    /* End Banner */
    System.out.println(
        "+---------------PrintTextToBinaryPacketCableDigitMap End-----------------+");
  }
  ...
  public void PrintTextToBinaryPacketCableJSONDump() {
    /* Start Banner */
    System.out.println(
        "+---------------PrintTextToBinaryPacketCableJSONDump Start---------------+");
    ...
    /* End Banner */
    System.out.println(
        "+---------------PrintTextToBinaryPacketCableJSONDump End-----------------+");
  }
  ...
  public void PrintTlvDotNotationPacketCableDefinition() {
    /* Start Banner */
    System.out.println(
        "+---------------PrintTlvDotNotationPacketCableDefinition Start---------------+");
    ...
    /* End Banner */
    System.out.println(
        "+---------------PrintTlvDotNotationPacketCableDefinition End-----------------+");
  }
  ...
  public void TextToBinaryInsertCoSignCVC() {
    ...
    arguments[1] = "-i";
    arguments[2] =
        TestDirectoryStructure.fInputDirFileName("DOCSIS-GOLDEN-NO-MAN-CVC.txt").toString();
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("DOCSIS-GOLDEN.bin.ManCVC.bin").toString();
    arguments[5] = "-cvc";
  ...
  public void TextToBinaryInsertDownstreamFrequecy() {
    /* Start Banner */
    System.out.println(
        "+---------------TextToBinaryInsertDownstreamFrequecy Start---------------+");
    ...
    arguments[1] = "-i";
    arguments[2] =
        TestDirectoryStructure.fInputDirFileName("DOCSIS-GOLDEN-INSERT-DS-FREQ-723000000.txt")
            .toString();
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("DOCSIS-GOLDEN.bin.DownstreamFrequency.bin")
            .toString();
    arguments[5] = "-df";
    ...
    /* End Banner */
    System.out.println(
        "+---------------TextToBinaryInsertDownstreamFrequecy End-----------------+");
  }
  ...
  public void TextToBinaryInsertMaxCPE() {
    ...
    arguments[1] = "-i";
    arguments[2] =
        TestDirectoryStructure.fInputDirFileName("DOCSIS-GOLDEN-INSERT-MAX-CPE-32.txt").toString();
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("DOCSIS-GOLDEN.bin.MaxCPE.bin").toString();
    arguments[5] = "-m";
    arguments[6] = "32";
  ...
  public void TextToBinaryInsertTLV() {
    ...
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("DOCSIS-GOLDEN.bin.INSERT-TLV-020101.bin")
            .toString();
    arguments[5] = "-t";
    arguments[6] = "020101";
  ...
  public void TextToBinaryPacketCable() {
    ...
    arguments[1] = "-i";
    arguments[2] =
        TestDirectoryStructure.fInputDirFileName("IMS-PKT-CABLE-CONFIG.bin.txt").toString();
    arguments[3] = "-o";
  ...
  public void TextToBinaryPacketCableInsertDigitMap() {
    /* Start Banner */
    System.out.println(
        "+---------------TextToBinaryPacketCableInsertDigitMap Start---------------+");
    ...
    arguments[1] = "-i";
    arguments[2] =
        TestDirectoryStructure.fInputDirFileName("IMS-PKT-CABLE-CONFIG-NO-DIGITMAP.txt").toString();
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("IMS-PKT-CABLE-CONFIG.txt.InsertDigitMap.bin")
            .toString();
    arguments[5] = "-dm";
    ...
    /* End Banner */
    System.out.println(
        "+---------------TextToBinaryPacketCableInsertDigitMap End-----------------+");
  }
  ...
  public void BinaryToBinaryInsertMultiDigitMap() {
    ...
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("IMS-PKT-CABLE-CONFIG.bin.InsertDigitMap.bin")
            .toString();
    arguments[5] = "-dm";
    arguments[6] =
        TestDirectoryStructure.fInputDirFileName("DigitMap.txt").toString()
            + "|1.3.6.1.4.1.4491.2.2.8.2.1.1.3.1.1.2.1"
            + " "
            + TestDirectoryStructure.fInputDirFileName("DigitMap.txt").toString()
            + "|1.3.6.1.4.1.4491.2.2.8.2.1.1.3.1.1.2.12";
    arguments[7] = "-s";
    arguments[8] = "p";
    arguments[9] = "2.0";
  ...
  public void TextToBinaryInsertTFTPServerAddress() {
    ...
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("DOCSIS-GOLDEN.txt.InsertTFTPv4.bin").toString();
    arguments[5] = "-T";
    arguments[6] = sIPv4;
    arguments[7] = "";
    ...
    /* Define arguments */
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("DOCSIS-GOLDEN.txt.InsertTFTPv6.bin").toString();
    arguments[6] = sIPv6;
    ...
    /* Define arguments */
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("DOCSIS-GOLDEN.txt.InsertTFTPv4.InsertTFTPv6.bin")
            .toString();
    arguments[6] = sIPv4;
    arguments[7] = sIPv6;
  ...
  public void TextToBinaryInsertOID() {
    ...
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("DOCSIS-GOLDEN.txt-SnmpOID-Insertion.bin")
            .toString();
    arguments[5] = "-O";
  ...
  public void PrintBinaryToTextDOCSISHexDumpToplevelTLV() {
    /* Start Banner */
    System.out.println(
        "+---------------PrintBinaryToTextDOCSISHexDumpToplevelTLV Start---------------+");
    ...
    /* End Banner */
    System.out.println(
        "+---------------PrintBinaryToTextDOCSISHexDumpToplevelTLV End-----------------+");
  }
  ...
  public void BinaryToBinaryDPoE() {
    ...
    arguments[1] = "-i";
    arguments[2] =
        TestDirectoryStructure.fInputDirFileName("d11_m_fte6083_encap1q_3950.cm").toString();
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("d11_m_fte6083_encap1q_3950.cm").toString();
  ...
  public void TextToBinaryDPoE() {
    ...
    arguments[1] = "-i";
    arguments[2] =
        TestDirectoryStructure.fInputDirFileName("d11_m_fte6083_encap1q_3950.cm.txt").toString();
    arguments[3] = "-o";
    arguments[4] =
        TestDirectoryStructure.fOutputDirFileName("d11_m_fte6083_encap1q_3950.cm").toString();
  ...
  public void MergeBulk() {
    ...
    arguments[1] = "b";
    arguments[2] =
        TestDirectoryStructure.fTestDirPath
            + File.separator
            + "inputmerge"
            + File.separator
            + "Model";
  ...
  public void PrintBinaryToTextDOCSISHexDumpString() {
    /* Start Banner */
    System.out.println(
        "+---------------PrintBinaryToTextDOCSISHexDumpString Start---------------+");
    ...
    /* End Banner */
    System.out.println(
        "+---------------PrintBinaryToTextDOCSISHexDumpString End-----------------+");
  }
}
