...
public class ConfigurationFileBuildAPITestMethods implements TestMethod {
  ...
  public void TextToBinaryDOCSIS() {
    ...
    ConfigurationFile cf =
        new ConfigurationFile(ConfigurationFile.DOCSIS_VER_31, cfi.getTlvBuilder(), SHARED_SECRET);
  ...
  public void TextToBinaryPacketCable(int iPacketCableVersion) {
    ...
    System.out.println(
        "Testing Text Configuration File to Binary Configuation File - PACKET-CABLE-"
            + iPacketCableVersion);
    System.out.println(
        "-----------------------------------------------------------------------------");
    ...
    cf.setConfigurationFileName(
        TestDirectoryStructure.fOutputDirFileName(sFileName + "-" + iPacketCableVersion + ".bin"));
  ...
  public void TextToBinaryInsertManufactureCVC() {
    ...
    System.out.println(
        "Testing Text Configuration File to Binary Configuation File - DOCSIS - Insert -"
            + " Manufacture CVC");
    System.out.println(
        "-----------------------------------------------------------------------------------------------");
    ...
    try {
      ...
      CommonTlvInsertions.insertManufactureCVC(
          TestDirectoryStructure.fCertificateDirFileName("COMCAST_CVC.der"), cf, false);
    } catch (ConfigurationFileException e) {
      e.printStackTrace();
    }
  ...
  public void TextToBinaryInsertCoSignCVC() {
    ...
    System.out.println(
        "Testing Text Configuration File to Binary Configuation File - DOCSIS - Insert - CoSign"
            + " CVC");
    System.out.println(
        "------------------------------------------------------------------------------------------");
    ...
    try {
      ...
      CommonTlvInsertions.insertCoSignCVC(
          TestDirectoryStructure.fCertificateDirFileName("COMCAST_CVC.der"), cf, false);
    } catch (ConfigurationFileException e) {
      e.printStackTrace();
    }
  ...
  public void TextToBinaryInsertDownstreamFrequecy() {
    ...
    System.out.println(
        "Testing Text Configuration File to Binary Configuation File - DOCSIS - Insert - Downstream"
            + " Frequency");
    System.out.println(
        "----------------------------------------------------------------------------------------------------");
    ...
    cf.setConfigurationFileName(
        TestDirectoryStructure.fOutputDirFileName(
            "DOCSIS-GOLDEN-INSERT-DS-FREQ-723000000 " + ".bin"));
  ...
  public void TextToBinaryInsertMaxCPE() {
    ...
    System.out.println(
        "Testing Text Configuration File to Binary Configuation File - DOCSIS - Insert - Max CPE -"
            + " 32");
    System.out.println(
        "--------------------------------------------------------------------------------------------");
    ...
    cf.setConfigurationFileName(
        TestDirectoryStructure.fOutputDirFileName("DOCSIS-GOLDEN-MAX-CPE-32" + ".bin"));
  ...
  public void TextToBinaryInsertTLV() {
    ...
    System.out.println(
        "Testing Text Configuration File to Binary Configuation File - DOCSIS - Insert - TLV -"
            + " 020101");
    System.out.println(
        "--------------------------------------------------------------------------------------------");
    ...
    cf.setConfigurationFileName(
        TestDirectoryStructure.fOutputDirFileName(sFileName + "-INSERT-TLV-020101.bin"));
  ...
  public void TextToBinaryPacketCableInsertDigitMap() {
    ...
    System.out.println(
        "Testing Text Configuration File to Binary Configuation File - PACKET-CABLE-20");
    System.out.println(
        "-----------------------------------------------------------------------------");
    ...
    cf.add(
        DigitMapOperation.getDigitMapTlvBuilder(
            TestDirectoryStructure.fDigitMapDirFileName(sDigitMap)));
  ...
  public void BinaryToTextDOCSIS() {
    ...
    ConfigurationFileExport cfe =
        new ConfigurationFileExport(TestDirectoryStructure.fInputDirFileName(sFileName));

    cfe.writeToDisk(TestDirectoryStructure.fOutputDirFileName(sFileName + ".txt"));

    // Get ByteArray for MD5 HashCheck
    byte[] bMD5_HASH_INSERT =
        CheckSum.getMD5(
            HexString.fileToByteArray(
                TestDirectoryStructure.fOutputDirFileName(sFileName + ".txt")));
  ...
  public void GetDigitMapFromBinary() {
    ...
    Disk.writeToDisk(
        hsDigitMap.toByteArray(), TestDirectoryStructure.fOutputDirFileName("DigitMap.txt"));
  }
  ...
  public void BinaryToBinaryDOCSIS() {
    ...
    try {
      cf =
          new ConfigurationFile(cfe.getConfigurationFileType(), cfe.getTlvBuilder(), SHARED_SECRET);
    } catch (TlvException e) {
      e.printStackTrace();
    }
    ...
    cf.setConfigurationFileName(
        TestDirectoryStructure.fOutputDirFileName(sFileName + "-BinToBin.bin"));
  ...
  public void BinaryToBinaryPacketCable() {
    ...
    System.out.println(
        "Testing Binary Configuration File to Binary Configuation File - PacketCable");
    System.out.println("----------------------------------------------------------------------");
  ...
  public void BinaryToTextDOCSISMaxCPE() {
    ...
    System.out.println(
        "Testing Binary Configuration File to Text Configuation File - DOCSIS-MAX-CPE");
    System.out.println(
        "----------------------------------------------------------------------------");
    ...
    byte[] bMD5_HASH_INSERT =
        CheckSum.getMD5(
            HexString.fileToByteArray(
                TestDirectoryStructure.fOutputDirFileName(sFileName + ".MaxCPE.txt")));
  ...
  public void BinaryToTextDOCSISFirmwareFileName() {
    ...
    System.out.println(
        "Testing Binary Configuration File to Text Configuation File - DOCSIS-FIRMWARE");
    System.out.println(
        "-----------------------------------------------------------------------------");
    ...
    byte[] bMD5_HASH_INSERT =
        CheckSum.getMD5(
            HexString.fileToByteArray(
                TestDirectoryStructure.fOutputDirFileName(sFileName + ".FirmwareFilename.txt")));
  ...
  public void BinaryToTextDOCSISManCVC() {
    ...
    System.out.println(
        "Testing Binary Configuration File to Text Configuation File - DOCSIS-MAN-CVC");
    System.out.println(
        "----------------------------------------------------------------------------");
    ...
    try {
      CommonTlvInsertions.insertManufactureCVC(
          TestDirectoryStructure.fCertificateDirFileName("COMCAST_CVC.der"), cf, true);
    } catch (ConfigurationFileException e) {
      e.printStackTrace();
    }
    ...
    byte[] bMD5_HASH_INSERT =
        CheckSum.getMD5(
            HexString.fileToByteArray(
                TestDirectoryStructure.fOutputDirFileName(sFileName + ".ManCVC.txt")));
  ...
  public void BinaryToTextDOCSISCoSignCVC() {
    ...
    System.out.println(
        "Testing Binary Configuration File to Text Configuation File - DOCSIS-CO-SIGN-CVC");
    System.out.println(
        "--------------------------------------------------------------------------------");
    ...
    byte[] bMD5_HASH_INSERT =
        CheckSum.getMD5(
            HexString.fileToByteArray(
                TestDirectoryStructure.fOutputDirFileName(sFileName + ".CoSignCVC.txt")));
  ...
  /**
   * This test has an issue where if you insert the CoSign then Manufacture CVC it will not insert
   * Both, Typicaly you would not do both at the same time in production
   *
  ...
  public void BinaryToTextDOCSIS_TLV_MaxCPE_Firmware_Man_CoSignCVC() {
    ...
    System.out.println(
        "Testing Binary Configuration File to Text Configuation File -"
            + " DOCSIS-TLV-FIRMWARE-MAN-CO-SIGN-CVC");
    System.out.println(
        "-------------------------------------------------------------------------------------------------");
    ...
    List<HexString> lhs =
        TlvBuilder.topLevelTlvToHexStringList(
            cf.toByteArray(), new HashMap<Integer, Integer>(1, 1));

    if (localDebug) {
      for (HexString hs : lhs) System.out.println("TestAPI: " + hs.toString(":"));
    }

    cfe = new ConfigurationFileExport(cf);

    cfe.writeToDisk(
        TestDirectoryStructure.fOutputDirFileName(sFileName + ".TlvFirmwareManCoSignCVC.txt"));
    ...
    byte[] bMD5_HASH_INSERT =
        CheckSum.getMD5(
            HexString.fileToByteArray(
                TestDirectoryStructure.fOutputDirFileName(
                    sFileName + ".TlvFirmwareManCoSignCVC.txt")));
  ...
  public void BinaryToBinaryDOCSIS_TLV_MaxCPE_Firmware_Man_CoSignCVC() {
    ...
    // Set the FileName
    cf.setConfigurationFileName(
        TestDirectoryStructure.fOutputDirFileName(sFileName + ".TlvFirmwareManCoSignCVC.bin"));
    ...
    byte[] bMD5_HASH_INSERT =
        CheckSum.getMD5(
            HexString.fileToByteArray(
                TestDirectoryStructure.fOutputDirFileName(
                    sFileName + ".TlvFirmwareManCoSignCVC.bin")));
  ...
  public void PrintDefaultDOCSISConfigurationTemplate() {
    ...
    ConfigurationFileExport cfr =
        new ConfigurationFileExport(ConfigurationFileExport.DOCSIS_VER_31);

    Disk.writeToDisk(
        cfr.toPrettyPrint(ConfigurationFileExport.EXPORT_FOUND_TLV),
        TestDirectoryStructure.fOutputDirFileName(sFileName));

    // Get ByteArray for MD5 HashCheck
    byte[] bMD5_HASH_INSERT =
        CheckSum.getMD5(
            HexString.fileToByteArray(TestDirectoryStructure.fOutputDirFileName(sFileName)));
  ...
  public void PrintTlvDotNotationDOCSISDefinition() {
    ...
    Disk.writeToDisk(
        cfe.getTlvDefintion(sTlvDotNotation), TestDirectoryStructure.fOutputDirFileName(sFileName));
  ...
  public void PrintDOCSISJSONDump() {
    ...
    Disk.writeToDisk(
        td.getTlvDictionary().toString(),
        TestDirectoryStructure.fOutputDirFileName(sFileName + "-JSON.txt"));
  ...
  public void PrintPacketCableJSONDump() {
    ...
    TlvDisassemble td =
        new TlvDisassemble(
            cfi.getTlvBuilder(), DictionarySQLQueries.PACKET_CABLE_DICTIONARY_TABLE_NAME);
  ...
  public void PrintTlvToJSON() {
    ...
    Disk.writeToDisk(
        td.getTlvDictionary().toString(),
        TestDirectoryStructure.fOutputDirFileName(sTLV + "-JSON.txt"));
  ...
  public void PrintJSONToTlv() {
    ...
    // Get ByteArray for MD5 HashCheck
    byte[] bMD5_HASH_INSERT =
        CheckSum.getMD5(HexString.fileToByteArray(TestDirectoryStructure.fOutputDirFileName(sTLV)));
  ...
  public void BulkBuildToText() {
    ...
    BulkBuild bb =
        new BulkBuild(
            TestDirectoryStructure.inputBulkDir(),
  ...
  public void BinaryToBinaryInsertMultiDigitMap() {
    ...
    cf.add(
        DigitMapOperation.getDigitMapTlvBuilder(
            HexString.fileToByteArray(TestDirectoryStructure.fDigitMapDirFileName(sDigitMap)),
            sDigitMapOID1));
  ...
  public void TextToBinaryFullDOCSISConfiguration() {
    ...
    System.out.println(
        "Testing Full DOCSIS Text Configuration File to Binary Configuation File - DOCSIS");
    System.out.println(
        "--------------------------------------------------------------------------------");
  ...
  public void TextToBinaryInsertTFTPServerAddress() {
    ...
    System.out.println(
        "Testing Text Configuration File to Binary Configuation File - DOCSIS - Insert - TFTP"
    ...
    cf.setConfigurationFileName(
        TestDirectoryStructure.fOutputDirFileName(sFileName + "-TFTP-SERVER.bin"));
  ...
  public void BinaryToTextDOCSISTFTPServerAddress() {
    ...
    System.out.println(
        "Testing Binary Configuration File to Text Configuation File - DOCSIS - Insert - TFTP"
            + " Server IPv4 & IPv6 Address");
    System.out.println(
        "---------------------------------------------------------------------------------------------------------------");
    ...
    byte[] bMD5_HASH_INSERT =
        CheckSum.getMD5(
            HexString.fileToByteArray(
                TestDirectoryStructure.fOutputDirFileName(sFileName + "-TFTP-SERVER.txt")));
  ...
  public void BinaryToTextInsertOID() {
    ...
    System.out.println(
        "Testing Binary Configuration File to Text Configuation File - Insert SNMP OID");
    System.out.println(
        "-----------------------------------------------------------------------------");
      ...
      try {
        cf =
            new ConfigurationFile(
                cfe.getConfigurationFileType(), cfe.getTlvBuilder(), SHARED_SECRET);
      } catch (TlvException e) {
        e.printStackTrace();
      }
    }
    ...
    CommonTlvInsertions.insertSnmpOID(
        sOID, BERService.berStringDataTypeToByte(BERService.OCTETSTRING), sValue, cf, false);

    cfe = new ConfigurationFileExport(cf);

    cfe.writeToDisk(
        TestDirectoryStructure.fOutputDirFileName(sFileName + "-Snmp-OID-Insertion.txt"));
  ...
  public void TextToBinaryInsertOID() {
    ...
    System.out.println(
        "Testing Text Configuration File to Binary Configuation File - DOCSIS - Insert - SNMP-OID");
    System.out.println(
        "-----------------------------------------------------------------------------------------------");
    ...
    if (cfi.getConfigurationFileType() > ConfigurationFileImport.DOCSIS_VER_31) {
      ...
      cf =
          new ConfigurationFile(cfi.getConfigurationFileType(), cfi.getTlvBuilder(), SHARED_SECRET);
    }
    ...
    cf.setConfigurationFileName(
        TestDirectoryStructure.fOutputDirFileName(sFileName + "-SnmpOID-Insertion.bin"));
