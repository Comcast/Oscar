...
public class tlvParser extends Parser {
  ...
  public static final int T__20 = 1,
      ...
      IP_PORT_RANGE = 42,
      HEX_NIBBLE = 43,
      HEX_NIBBLE_UPPERCASE = 44,
      HEX_NIBBLE_LOWERCASE = 45,
      HEX_BYTE = 46,
      HEX_BYTE_UPPER_CASE = 47,
      HEX_BYTE_LOWER_CASE = 48,
      ALPHA_NUMERIC = 49,
      IDENTIFIER = 50,
      SINGLE_QUOTE_STRING = 51,
      EMBEDDED_STRING = 52,
      HEX_ARRAY = 53,
      VALUE_BIT_ARRAY = 54,
      VALUE_DOUBLE_BYTE_ARRAY = 55,
      MAC_ADDRESS_ARRAY = 56,
      IPv4_ADDRESS = 57,
      IPv4_TRANSPORT_ADDRESS = 58,
      IPv6_ADDRESS = 59,
      IPv6_TRANSPORT_ADDRESS = 60,
      MULTI_LINE_COMMENT = 61,
      INT_OID = 62,
      STRING_OID = 63,
      EMBEDDED_NO_STRING = 64,
      SINGLE_QUOTE_NO_STRING = 65,
      SNMP_OID_1 = 66,
      SNMP_OID = 67;
  public static final String[] tokenNames = {
    ...
    "IP_PORT_RANGE",
    "HEX_NIBBLE",
    "HEX_NIBBLE_UPPERCASE",
    "HEX_NIBBLE_LOWERCASE",
    "HEX_BYTE",
    "HEX_BYTE_UPPER_CASE",
    "HEX_BYTE_LOWER_CASE",
    "ALPHA_NUMERIC",
    ...
    "STRING_OID",
    "EMBEDDED_NO_STRING",
    "SINGLE_QUOTE_NO_STRING",
    "SNMP_OID_1",
    "SNMP_OID"
  };
  public static final int RULE_configType = 0,
      RULE_startTLV = 1,
      RULE_tlv = 2,
      RULE_sTlv = 3,
      RULE_type = 4,
  ...
  public final ConfigTypeContext configType() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        if (!((((_la) & ~0x3f) == 0
            && ((1L << _la)
                    & ((1L << 2) | (1L << 5) | (1L << 11) | (1L << 12) | (1L << 17) | (1L << 20)))
                != 0))) {
  ...
  public static class TlvContext extends ParserRuleContext {
    public TerminalNode IDENTIFIER() {
      return getToken(tlvParser.IDENTIFIER, 0);
    }
  ...
  public static class TypeValueContext extends ParserRuleContext {
    public TerminalNode IPv4_ADDRESS() {
      return getToken(tlvParser.IPv4_ADDRESS, 0);
    }

    public TerminalNode IPv6_ADDRESS() {
      return getToken(tlvParser.IPv6_ADDRESS, 0);
    }

    public TerminalNode SEMICOLON() {
      return getToken(tlvParser.SEMICOLON, 0);
    }

    public TerminalNode IPv4_TRANSPORT_ADDRESS() {
      return getToken(tlvParser.IPv4_TRANSPORT_ADDRESS, 0);
    }

    public TerminalNode INT() {
      return getToken(tlvParser.INT, 0);
    }
    ...
    public TerminalNode HEX_ARRAY() {
      return getToken(tlvParser.HEX_ARRAY, 0);
    }

    public TerminalNode VALUE_BIT_ARRAY() {
      return getToken(tlvParser.VALUE_BIT_ARRAY, 0);
    }

    public TerminalNode IPv6_TRANSPORT_ADDRESS() {
      return getToken(tlvParser.IPv6_TRANSPORT_ADDRESS, 0);
    }

    public TerminalNode VALUE_DOUBLE_BYTE_ARRAY() {
      return getToken(tlvParser.VALUE_DOUBLE_BYTE_ARRAY, 0);
    }

    public TerminalNode MULTI_LINE_COMMENT() {
      return getToken(tlvParser.MULTI_LINE_COMMENT, 0);
    }

    public TerminalNode MAC_ADDRESS_ARRAY() {
      return getToken(tlvParser.MAC_ADDRESS_ARRAY, 0);
    }
        ...
        if (!((((_la) & ~0x3f) == 0
            && ((1L << _la)
                    & ((1L << INT)
                        ...
                        | (1L << HEX_ARRAY)
                        | (1L << VALUE_BIT_ARRAY)
                        | (1L << VALUE_DOUBLE_BYTE_ARRAY)
                        | (1L << MAC_ADDRESS_ARRAY)
                        | (1L << IPv4_ADDRESS)
                        | (1L << IPv4_TRANSPORT_ADDRESS)
                        | (1L << IPv6_ADDRESS)
                        | (1L << IPv6_TRANSPORT_ADDRESS)))
                != 0))) {
          _errHandler.recoverInline(this);
        }
        consume();
  ...
  public static class SubContext extends ParserRuleContext {
    ...
    public TerminalNode LBRACE() {
      return getToken(tlvParser.LBRACE, 0);
    }
    ...
    public TerminalNode RBRACE() {
      return getToken(tlvParser.RBRACE, 0);
    }
      ...
      enterOuterAlt(_localctx, 1);
      {
        ...
        do {
          ...
          _la = _input.LA(1);
            ...
            && ((1L << _la) & ((1L << 18) | (1L << 19) | (1L << IDENTIFIER))) != 0));
        setState(77);
        match(RBRACE);
      }
    } catch (RecognitionException re) {
  ...
  public static class SnmpContext extends ParserRuleContext {
    ...
    public List<TerminalNode> DOUBLE_QUOTE() {
      return getTokens(tlvParser.DOUBLE_QUOTE);
    }
